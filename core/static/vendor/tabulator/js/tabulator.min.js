...
!(function (e, t) {
  ...
  class f extends t {
    ...
    redraw(e) {
      this.adjustTableSize(),
        ...
        e
          ? this.renderTable()
          : (this.reRenderInPosition(), this.scrollHorizontal(this.scrollLeft));
    }
    resetScroll() {
      if (
  ...
  class _ extends H {
    ...
    static initializeModuleBinder(e) {
      _.modulesRegistered ||
        ((_.modulesRegistered = !0),
        _._registerModules(F, !0),
        e && _._registerModules(e));
    }
    ...
    static _registerModuleBinding(e) {
      e.moduleName
        ? (_.moduleBindings[e.moduleName] = e)
        : console.error(
      ...
      if (e.moduleExtensions)
        for (let e in t) {
          ...
          if (_.moduleBindings[e]) for (let t in i) _._extendModule(e, t, i[t]);
            ...
            for (let t in i)
              _.moduleExtensions[e][t] || (_.moduleExtensions[e][t] = {}),
                Object.assign(_.moduleExtensions[e][t], i[t]);
          }
        }
  ...
  function N(e, t) {
    ...
    if (((t = t || ""), Array.isArray(e)))
      ...
      for (var s in e) i = i.concat(N(e[s], t ? t + "[" + s + "]" : s));
  ...
  class ee extends M {
    ...
    generateRow(e, t) {
      ...
      return (
        ...
        (i.component = !1),
        (i.getComponent = () => (
          i.component || (i.component = new Q(i)), i.component
        )),
        (i.generateCells = () => {
          var t = [];
  ...
  let oe = class {
    ...
    _createInputElement() {
      ...
      return (
        this.params.mask && se(t, this.params), this._bindInputEvents(t), t
      );
    }
    _initializeParams(e) {
      var t,
  ...
  class Fe extends M {
    ...
    initializePageCounter() {
      var e = this.table.options.paginationCounter,
        t = null;
      e &&
        ((t = "function" == typeof e ? e : Fe.pageCounters[e])
          ? ((this.pageCounter = t),
  ...
  var je = {
    ...
    time: function (e, t, i, s, o, n, r) {
      return (
        r.format || (r.format = "HH:mm"), We.call(this, e, t, i, s, o, n, r)
      );
    },
    datetime: We,
  ...
  var Ye = Object.freeze({
    ...
    SelectRangeModule: class extends M {
      ...
      newSelection(e, t) {
        ...
        if ("column" === t.type) {
          ...
          t.column === this.rowHeader
            ...
            : (this.selecting = "cell");
        e.shiftKey
          ? this.activeRange.setBounds(!1, t)
          : e.ctrlKey
          ? this.addRange().setBounds(t)
          : this.resetRanges().setBounds(t);
      }
      autoScroll(e, t, i) {
        var s,
      ...
      redraw(e) {
        e &&
          ((this.selecting = "cell"), this.resetRanges(), this.layoutElement());
      }
      layoutElement(e) {
        (e
